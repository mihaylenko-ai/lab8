...
В качестве исходной сети была использована ранее спроектированная лабораторная сеть из Лаборатоной роботы №6. Все сетевые устройства имеют свои уникальные имена, отражающие их
...
|3|BGW|VLAN50|192.168.50.3|24|
|4|BGW|VLAN60|192.168.50.3|24|
...
В рамках лабораторной работы на предоставленном учебным центром лабораторном окружении было использовано семь коммутаторов. Данные коммутаторы были соеденины линиями связи по
...
соответственно, как следствие отсутствует возможность достепа между двумя Bridge доменами VLAN10 И VLAN20.
